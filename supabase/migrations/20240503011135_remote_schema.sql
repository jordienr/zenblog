...
CREATE TABLE IF NOT EXISTS "public"."blogs" (
    ...
    "slug" "text" NOT NULL,
    CONSTRAINT "blogs_slug_check" CHECK (("length"("slug") < 50))
);
...
CREATE OR REPLACE VIEW "public"."post_tags_with_tags" AS
 SELECT "pt"."id",
    "pt"."created_at",
    "pt"."post_id",
    "pt"."tag_id",
    "bt"."name" AS "tag_name",
    "bt"."slug" AS "tag_slug",
    "bt"."description" AS "tag_description"
   FROM ("public"."post_tags" "pt"
     LEFT JOIN "public"."blog_tags" "bt" ON (("pt"."tag_id" = "bt"."id")));

ALTER TABLE "public"."post_tags_with_tags" OWNER TO "postgres";
...
CREATE OR REPLACE VIEW "public"."public_posts_v1" AS
 SELECT "p"."created_at",
    "p"."blog_id",
    "p"."title",
    "p"."published",
...
ALTER TABLE "public"."public_posts_v1" OWNER TO "postgres";

CREATE OR REPLACE VIEW "public"."tag_usage_count_v2" AS
 SELECT "bt"."id" AS "tag_id",
    "bt"."blog_id",
    "bt"."name" AS "tag_name",
    "bt"."slug",
    "bt"."created_at",
   ...
   FROM ("public"."blog_tags" "bt"
     LEFT JOIN "public"."post_tags" "pt" ON (("bt"."id" = "pt"."tag_id")))
  GROUP BY "bt"."id", "bt"."blog_id", "bt"."name", "bt"."slug", "bt"."created_at", "bt"."updated_at";

ALTER TABLE "public"."tag_usage_count_v2" OWNER TO "postgres";
...
CREATE POLICY "Enable read access for all users" ON "public"."blogs" FOR SELECT TO "anon" USING (true);
...
GRANT ALL ON TABLE "public"."post_tags_with_tags" TO "anon";
GRANT ALL ON TABLE "public"."post_tags_with_tags" TO "authenticated";
GRANT ALL ON TABLE "public"."post_tags_with_tags" TO "service_role";
...
GRANT ALL ON TABLE "public"."public_posts_v1" TO "anon";
GRANT ALL ON TABLE "public"."public_posts_v1" TO "authenticated";
GRANT ALL ON TABLE "public"."public_posts_v1" TO "service_role";

GRANT ALL ON TABLE "public"."tag_usage_count_v2" TO "anon";
GRANT ALL ON TABLE "public"."tag_usage_count_v2" TO "authenticated";
GRANT ALL ON TABLE "public"."tag_usage_count_v2" TO "service_role";
