...
export const queryCode = `id/257c6096-c61c-4ff7-8111-24985ff69a12`;

export const query = {"Query":{"objectTypeName":"Query","selection":{"root":{"fieldArguments":{"__isPartialObject__":true},"fieldQuery":{"Root":{"objectTypeName":"Root","selection":{"postViewCounter":{"fieldArguments":{},"fieldQuery":null},"exampleFlag":{"fieldArguments":{},"fieldQuery":null}}}}}}}};
...
export const vercelFlagDefinitions = {"postViewCounter":{"options":[{"value":true},{"value":false}],"origin":"https://app.hypertune.com/projects/3406/draft?view=logic&selected_field_path=root%3EpostViewCounter"},"exampleFlag":{"options":[{"value":true},{"value":false}],"origin":"https://app.hypertune.com/projects/3406/draft?view=logic&selected_field_path=root%3EexampleFlag"}};
...
export type Root = {
  postViewCounter: boolean;
  exampleFlag: boolean;
}

const rootFallback = {postViewCounter:false,exampleFlag:false};
...
export class RootNode extends sdk.Node {
  ...
  /**
   * [Open in UI]({@link https://app.hypertune.com/projects/3406/draft?view=logic&selected_field_path=root%3EpostViewCounter})
   */
  postViewCounter({ args = {}, fallback }: { args?: Rec; fallback: boolean; }): boolean {
    const props0 = this.getField("postViewCounter", args);
  ...
  /**
   * [Open in UI]({@link https://app.hypertune.com/projects/3406/draft?view=logic&selected_field_path=root%3EexampleFlag})
   */
...
const sourceFallback = {root:{postViewCounter:false,exampleFlag:false}};
